...
class CreateEmployerPage extends StatefulWidget {
  const CreateEmployerPage({super.key});

  @override
  State<CreateEmployerPage> createState() => _CreateEmployerPageState();
}

class _CreateEmployerPageState extends State<CreateEmployerPage> {
                  ...
                  child: InkWell(
                    onTap: () async {
                      ...
                      if (email.text.isEmpty ||
                        ...
                        var checkRegister =
                            await NguoiDungProvider.themMoi(employer);
                        if (checkRegister != null) {
                          employer.id = checkRegister;
                          showToast(
                            context: context,
                            msg: "Thêm doanh nghiệp thành công",
                          ...
                          showToast(
                            context: context,
                            msg: "Thêm doanh nghiệp không thành công",
                            color: const Color.fromARGB(255, 255, 179, 86),
                            icon: const Icon(Icons.info),
                          );
                        }
