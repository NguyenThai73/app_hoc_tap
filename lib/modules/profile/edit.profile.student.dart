...
class EditProfileStudentPage extends StatefulWidget {
  ...
  const EditProfileStudentPage({super.key, required this.sinhvien});

  @override
  State<EditProfileStudentPage> createState() => _EditProfileStudentPageState();
}
                        ...
                        onTap: () async {
                          if (email.text.isEmpty ||
                            ...
                            if (checkRegister) {
                              ...
                              prefs.setInt("role", singvien.role ?? 0);
                              prefs.setInt("id", singvien.id ?? 0);
                              prefs.setString("avatar", singvien.avatar ?? "");
                              prefs.setString("name", singvien.fullName ?? "");
                              showToast(
                                context: context,
