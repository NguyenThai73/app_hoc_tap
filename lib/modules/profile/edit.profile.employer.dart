...
class EditProfileEmployerPage extends StatefulWidget {
  final UserModel employer;
  const EditProfileEmployerPage({super.key, required this.employer});

  @override
  State<EditProfileEmployerPage> createState() =>
      _EditProfileEmployerPageState();
}

class _EditProfileEmployerPageState extends State<EditProfileEmployerPage> {
                    ...
                    onTap: () async {
                      ...
                      if (email.text.isEmpty ||
                        ...
                        if (checkRegister) {
                          ...
                          prefs.setInt("role", employer.role ?? 0);
                          prefs.setInt("id", employer.id ?? 0);
                          prefs.setString("avatar", employer.avatar ?? "");
                          prefs.setString("name", employer.fullName ?? "");
                          showToast(
                            context: context,
